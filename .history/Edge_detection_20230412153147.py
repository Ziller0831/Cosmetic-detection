...
while 1:
    ...
    retval, r = cv2.threshold(frame, R_val, maxVal, cv2.THRESH_OTSU)
    retval, g = cv2.threshold(frame, G_val, maxVal, cv2.THRESH_OTSU)
    retval, b = cv2.threshold(frame, B_val, maxVal, cv2.THRESH_OTSU)
