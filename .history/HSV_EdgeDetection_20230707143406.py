...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            cv2.circle(frame, sorted_vertices[0], 3, (0,100,255), -1)
            cv2.circle(frame, sorted_vertices[1], 3, (0,0,255), -1)
            cv2.circle(frame, sorted_vertices[2], 3, (0,0,255), -1)
            cv2.circle(frame, sorted_vertices[3], 3, (0,0,255), -1)
