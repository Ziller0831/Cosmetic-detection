...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            minAreaRect = MinRectCircle(contour)
            box = cv2.boxPoints(minAreaRect)
            box = np.int0(box)

            center_point = minAreaRect[0]
            minRect = minAreaRect[1]
            rawTheta = minAreaRect[2]
            ...
            # cv2.circle(frame, [top_point_x, top_point_y], 3, (0,255,0), -1)
            # cv2.circle(frame, [bottom_point_x, bottom_point_y], 3, (0,0,255), -1)
            # cv2.circle(frame, [left_point_x, left_point_y], 3, (0,0,255), -1)
            # cv2.circle(frame, [right_point_x, right_point_y], 3, (0,0,255), -1)
