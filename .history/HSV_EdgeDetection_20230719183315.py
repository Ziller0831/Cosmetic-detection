...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            pre_theta = theta
            x = 0
            if long_GC_cos < 0 and long_GC_cos >= -1 and theta < 90 or theta > 270: ## 第三像限反轉
            ...
            try:
                print(f"{x}:{long_GC_cos:.2f}, {pre_theta:.2f}, {theta:.2f}, {short_vect}")
                ...
                cv2.arrowedLine(frame, center_point, endPoint, (100,50,70), 2)
