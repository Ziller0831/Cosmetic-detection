...
def delet_contours(contours):
    ...
    # for i, del_con in enumerate(delete_list):
    #     del contours[del_con - delta]
...
while 1:
    ...
    # for i, contour in enumerate(contours):
    #     contoursLength = cv2.arcLength(contour, True)
    #     if (contoursLength < Contour_size[0]) or (contoursLength > Contour_size[1]):
    #         delete_list.append(i)

    contours = delet_contours(contours)
