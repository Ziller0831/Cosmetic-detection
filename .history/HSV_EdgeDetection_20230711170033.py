...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            length1 = ((gravity_point[0]-point1[0])**2+(gravity_point[1]-point1[0])**2)**0.5
            length2 = ((gravity_point[0]-point2[0])**2+(gravity_point[1]-point2[1])**2)**0.5

            if(length1 < length2):
                vector1 = gravity_point - point2
            elif(length1 > length2):
                vector1 = gravity_point - point2
            
            theta1 = cv2.fastAtan2(int(vector1[0]), int(vector1[1]))
            
            print(f"{gravity_point}, {point1},,{point2}, {vector}, {vector1},{length1:.4f},{length2:.4f}")
            ...
            endPoint = [int(center_point[0]+ArrowLength*cos(radians(theta))), int(center_point[1]+(-ArrowLength*sin(radians(theta1))))]
