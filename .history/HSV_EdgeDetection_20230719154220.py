...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            # theta = AngleIndentify(deltaY, theta)            endPoint = [int(center_point[0]+ArrowLength*math.cos(math.radians(theta))), int(center_point[1]+(-ArrowLength*math.sin(math.radians(theta))))]
