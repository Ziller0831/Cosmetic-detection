...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            cv2.rectangle(frame, (x, y), (x + w, y + h), (100, 10, 100), 2)
            ...
            top_right_index = np.where(sorted_vertices[:, 0] > center[0])[0][0]
            adjusted_vertices = np.roll(sorted_vertices, -top_right_index, axis=0)
            ...
            cv2.circle(frame, adjusted_vertices[1], 3, (100,100,255), 2)
            cv2.circle(frame, adjusted_vertices[2], 3, (100,100,255), 2)
            # cv2.circle(frame, vertices[2], 3, (100,100,255), 2)
            # cv2.circle(frame, minRect[3], 3, (100,100,255), 2)
