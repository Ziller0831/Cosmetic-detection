...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            long_GC_theta = math.arccos(long_GC_cos)

            if long_GC_theta < 0 and long_GC_theta >= -1:   ## 反向
                theta = (theta + 180)%360
            elif long_GC_theta > 0 and long_GC_theta <= 1:  ## 正向
                theta = theta

            try:
                print(f"{math.ceil(long_GC_theta)}, {long_GC_theta:.2f}, {theta:.2f}")
