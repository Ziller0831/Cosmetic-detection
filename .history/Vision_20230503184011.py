...
CsvDir = "C:\Users\jcyu\Documents\GitHub\OpenCV-image-process-test\Cosmetic_parameter.csv"
...
class EdgeDetector:
    def __init__(self, ProductName = "", CsvDir = ""):
        ...
        length_Std = product_dic.get('產品輪廓周長').get(product_index)
...
if __name__ == '__main__':
    ...
    cosmetic = EdgeDetector(ProductName)
    while True:
