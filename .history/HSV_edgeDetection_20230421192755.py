...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            text = f"({str(gravity_point[0])}, {str(gravity_point[1])}, {theta_1})" ## fstring
            # text = "({0}, {1})".format(str(gravity_point[0]), str(gravity_point[1])) ##另一種打法
            cv2.putText(frame, text, (gravity_point[0]+10, gravity_point[1]+10), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 255, 255), 2, 8, 0)
