...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            angle = np.where(angle<0, angle+2*np.pi)
            ...
            # cv2.circle(frame, sorted_vertices[1], 3, (100,100,255), -1)
            # cv2.circle(frame, sorted_vertices[2], 3, (100,100,255), -1)
            # cv2.circle(frame, sorted_vertices[3], 3, (100,100,255), -1)
