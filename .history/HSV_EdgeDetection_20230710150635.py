...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            a = moment['m20']/moment['m00'] - gravity_point[0]*gravity_point[0]
            b = moment['m11']/moment['m00'] - gravity_point[0]*gravity_point[1]
            c = moment['m02']/moment['m00'] - gravity_point[1]*gravity_point[1]

            deltaX, deltaY = gravity_point - center_point

            theta1 = cv2.fastAtan2(float(deltaY), float(deltaX))
            ...
            endPoint1 = [int(center_point[0]+ArrowLength*cos(radians(theta1))), int(center_point[1]+(-ArrowLength*sin(radians(theta1))))]

            cv2.arrowedLine(frame, center_point, (endPoint[0], endPoint[1]), (255,100,0), 2)
            cv2.arrowedLine(frame, center_point, (endPoint1[0], endPoint1[1]), (100,100,0), 2)
            
            cv2.circle(frame, center_point, 3, (0,255,0), -1)
            cv2.circle(frame, gravity_point, 3, (0,0,255), -1)
            # cv2.circle(frame, vertices[0], 3, (100,100,255), -1)
            # cv2.circle(frame, vertices[1], 3, (100,100,255), -1)
            # cv2.circle(frame, vertices[2], 3, (100,100,255), -1)
            # cv2.circle(frame, vertices[3], 3, (100,100,255), -1)
