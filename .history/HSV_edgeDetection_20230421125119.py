...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            cv2.circle(Result, Centroid_point, 2, (0,0,255), 2)
            text = "(" + str(Centroid_point[0]) + ", " + str(Centroid_point[1]) + ")"
            cv2.putText(Result, text, (Centroid_point[0]+10, Centroid_point[1]+10), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 255, 255), 1, 8, 0);
