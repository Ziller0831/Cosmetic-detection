...
cv2.createTrackbar('thres_1', 'Setting', 0, 255, nothing)
cv2.createTrackbar('thres_2', 'Setting', 0, 1000, nothing)
...
while True:
    thres_1 = cv2.getTrackbarPos('thres_1', 'Setting')
    thres_2 = cv2.getTrackbarPos('thres_2', 'Setting')
    ...
    ## Canny()
    canny_output = cv2.Canny(img, thres_1, thres_2)
