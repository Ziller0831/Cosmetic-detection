...
def MinRectCircle(contours):
    min_rect_array = []
    for contour in contours:
        raw_min_rect = cv2.minAreaRect(contour)
        raw_min_rectnp.int0(  # min_area_rectangle
        print(raw_min_rect[0])
        min_rect = cv2.boxPoints(raw_min_rect)
