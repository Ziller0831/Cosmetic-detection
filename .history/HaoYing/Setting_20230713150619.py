...
class initialize:
    ...
    def Camera_Calibration(self, cap):
        ...
        self.Standard_Catch(cap)
        print(self.Chessboard_path+"Stardard.png")
        std_img = cv2.imread(r'C:\Users\jcyu\Documents\GitHub\OpenCV-image-process-test\HaoYing\Standard.png)
