        ...
        for contour in contours:
            ...
            if self._modeSW == 2:
                ...
                try:
                    ...
                    catch_point = [int(center_p[0]+self.catchPoint*math.cos(math.radians(angle))), int(center_p[1]-self.catchPoint*math.sin(math.radians(angle)))]
                    cv2.arrowedLine(frame, center_p, (catch_point[0], catch_point[1]), (255,100,0), 2)
                except:
                    pass
                cv2.circle(frame, center_p, 5, (100,255,100), -1)
                cv2.circle(frame, gravity_p, 5, (0,0,255), -1)
                cv2.circle(frame, catch_point, 5, (255,0,255), -1)
