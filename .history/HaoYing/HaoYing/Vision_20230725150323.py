    ...
    def FeaturesCalc(self, frame, contours):
        ...
        for contour in contours:
            ...
            if self._modeSW == 2:
                ...
                try:catch_p = [int(center_p[0]+self.catchPoint*math.cos(math.radians(angle))), int(center_p[1]-self.catchPoint*math.sin(math.radians(angle)))]
                ...
                cv2.circle(frame, catch_p, 5, (255,0,255), -1)
