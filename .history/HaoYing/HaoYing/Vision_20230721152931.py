...
class EdgeDetector:
    def __init__(self, ModeSW = 2,  Product_name = "", TF_parm = "", *Product_features):
        ...
        if ModeSW == 2: ##% Working Mode
            _area_avg, _area_Std, _product_color, _catch_offset, _product_height = Product_features
            _robot_height = 540
FP.CSVDataLoad("E:\HaoYing\Cosmetic_parameter.csv", Product_name)
            ...
            self._X_offset = -225
            self._Y_offset = -102
            self._Z_offset = -_robot_height + _product_height
