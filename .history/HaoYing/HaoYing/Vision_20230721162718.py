...
class EdgeDetector:
    def __init__(self, ModeSW = 2, TF_parm = "", *Product_features):
        ...
        if ModeSW == 2: ##% Working Mode
            _area_avg       = Product_features[0]
            _area_Std       = Product_features[1]
            _product_color  = Product_features[2]
            _catch_offset   = Product_features[3]
            _product_height = Product_features[4]
            _robot_height   = 540
