...
from numpy import array, mean, int0, hstack
...
class EdgeDetector:
    def __init__(self, ModeSW = 0,  ProductName = "", CsvDir = "", TransferParameters = ""):
        ...
        if ModeSW == 0: ##% Working Mode
            ...
            self.projection_matrix = np.dot(TransferParameters["camera_matrix"], hstack((self.rvec_matrix, TransferParameters["tvecs"])))
            self.X_offset = 0
            self.Y_offset = 0
