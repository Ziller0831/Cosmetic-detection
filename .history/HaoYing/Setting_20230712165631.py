...
class initialize:
    def __init__(self):
        ...
        self.Chessboard_path = r"./HaoYing/Chessboard_path"
    ...
    def ScaleCalc(self, cap):
        ...
        widthScale = self.TargetEdgeSize / np.mean(array(Width, dtype=object))
        heightScale = self.TargetEdgeSize / np.mean(array(Height, dtype=object))
    ...
    def Chessboard_Catch(self):
        ...
        while count < 10:
            ...
            if  cv2.waitKey(1) & 0xFF != ord('q'):
                cv2.imwrite("chessboard/"+str(count)+'.png', frame, [int(cv2.IMWRITE_PNG_COMPRESSION), 0])
