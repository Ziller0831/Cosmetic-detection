...
class EdgeDetector:
    def __init__(self, ModeSW = 0,  Product_name = "", TF_parm = ""):
        ...
        if ModeSW == 2: ##% Working Mode
            _area_avg, _area_Std, _product_color, catch_offset, product_height =FP.CSVDataLoad(CsvDir, Product_name)
            ...
            self._Area_range = [_area_avg-_area_Std*5, Area_Avg+            self._Area_range = [_area_avg-_area_Std*5, Area_Avg+Area_St_area_Stdd*5]
*5]
