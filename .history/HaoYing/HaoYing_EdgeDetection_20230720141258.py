    ...
    if Mode == 0:  ##! 物件輪廓選擇mode
        ...
        while True:
            ...
            for result in results_mean:
                ...
                output = np.array([world_coordinate[0], world_coordinate[1], world_coordinate[2] object_angle])

                # print(output)
                # print(pixel_x, pixel_y, object_angle)
                # print(pixel_x, pixel_y, object_angle)object_angle
