...
class EdgeDetector:
    def __init__(self, ModeSW = 0,  ProductName = "", CsvDir = "", TransferParameters = ""):
        ...
        if ModeSW == 0: ##% Working Mode
            ...
            if product_color == '淺色': self.HSV_range = [np.array([180, 25, 255]), array([0, 0, 155])]
            elif product_color == '深色': self.HSV_range = [np.array([180, 255, 230]), array([0, 0, 154])]
    ...
    def Coordinate_TF(self, pixel_coordinate):
        array([pixel_coordinate], dtype=float32).T
