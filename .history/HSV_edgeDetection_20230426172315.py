...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            endPoint = [int(center_point[0]+ArrowLength*cos(radians(theta)), center_point[1]+ArrowLength*sin(radians(theta))]
            cv2.arrowedLine(frame, center_point, (endPoint[0], endPoint[1]), (255,0,0), 1)
