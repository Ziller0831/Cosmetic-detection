...
def WorkMode():
    ...
    XML_path = os.path.join(_path, 'Data', r'C:\Users\TEST\Desktop\HaoYing0801\Data\Setting.xml')
    for i in TF_para:
        TF_para[i] = FP.XMLRead(XML_path, str(i))
    
    product_path = os.path.join(_path, 'Data', r'C:\Users\TEST\Desktop\HaoYing0801\Data\Cosmetic_parameter.csv')
