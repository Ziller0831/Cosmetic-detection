...
if __name__ == '__main__':
    ...
    PointNumberMaxCont = max(PointNumberData)
    PointNumberMinCont = min(PointNumberData)
    PointNumberMeanCont = np.mean(np.array(PointNumberData, dtype=object))
    PointNumberStdCont = np.std(np.array(PointNumberData,  dtype=float), axis=0, ddof=1)
    print('AreaContours','Max:', PointNumberMaxCont, 'Min:', PointNumberMinCont, "Mean:", PointNumberMeanCont, 'Std:', areaStdCont)
    print(f'Area: Mean, Std; Length: Mean, Std; Point: Mean, Std\n{areaMeanCont:.4f},{areaStdCont:.4f},{LengthMeanCont:.4f},{LengthStdCont:.4f},{areaMeanCont:.4f},{areaStdCont:.4f}')
