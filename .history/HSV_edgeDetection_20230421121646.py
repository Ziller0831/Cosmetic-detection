...
if __name__ == '__main__':
    ...
    while True:
        ...
        raw_minRect, minRect_array = MinRectCircle(contours)
        ...
        cv2.circle(Result, raw_minRect[0], 2, (0,255,255), 2, -1)
