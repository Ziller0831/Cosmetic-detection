...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            length2 = ((gravity_point[0]-point2[1])**2+(gravity_point[1]-point2[1])**2)**0.5

            if(length1 < length2):
                vector1 = gravity_point - point2
            elif(length1 > length2):
                vector1 = gravity_point - point1
            
            theta1 = cv2.fastAtan2(int(vector1[1]), int(vector1[1]))
            
            print(f"a:{length1:.4f}, b:{length2:.4f}, {vector1},{theta:.4f},{theta1:.4f}")
