...
class EdgeDetector:
    def __init__(self, ProductName = "", CsvDir = ""):
        ...
        if product_color == '淺色': self.HSV_range = [[180, 25, 255], [0, 0, 155]]
        elif product_color == '深色': self.HSV_range = [[180, 255, 230], [0, 0, 154]]
    ...
    def ImagePreProcess(self, img_src):
        ...
        mask = cv2.inRange(HSV_img, self.HSV_range[0], self.HSV_range)
