...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            mu00 = moment['m00']
            mu11 = moment['m11'] - gravity_point[0]*moment['m01']
            mu20 = moment['m20'] - gravity_point[0]*moment['m10']
            mu02 = moment['m02'] - gravity_point[1]*moment['m01']

            # deltaX, deltaY = gravity_point - center_point

            # theta = cv2.fastAtan2(float(deltaY), float(deltaX))
            theta = (1/2*np.arctan2(2*mu11/mu00, (mu20-mu02)/mu00))*180/np.pi
