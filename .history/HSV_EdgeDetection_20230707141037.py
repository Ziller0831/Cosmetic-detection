...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            cv2.circle(frame, vertices[0], 3, (0,100,255), -1)
            # cv2.circle(frame, vertices[1], 3, (0,100,255), -1)
            cv2.circle(frame, vertices[2], 3, (0,100,255), -1)
            # cv2.circle(frame, vertices[3], 3, (0,100,255), -1)
