...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            print(f"{gravity_point}, {point1},{deltaX:.4f},{deltaY:.4f}. {theta:.4f}")
        ...
        for result in results_mean: 
            ...
            cv2.putText(frame, text, (int(result[0]+50), int(result[1]+50)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2, 8, 0)
