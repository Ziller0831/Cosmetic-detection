    ...
    while True:
        ...
        for contour in contoursList:
            if cv2.contourArea(contour) > 100:
                corner = cosmetic.MinRectCircle(contour)[1]
                Width.append(math.sqrt((corners[1][0] - corners[0][0])**2 + (corners[1][1] - corners[0][1])**2))
                Height.append(math.sqrt((corners[3][0] - corners[0][0])**2 + (corners[3][1] - corners[0][1])**2))
