...
def MinRectCircle(contour):
    ...
    return np.int0(rawMinRect[0]), min_rect, np.int0(rawMinRect[2])
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            try:
                print("%4d, %4d"%(theta, theta_1), end = "\r")
            except:
                continue
            ...
            cv2.putText(frame, text, (gravity_point[0]+10, gravity_point[1]+10), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 255, 255), 1, 8, 0)            cv2.putText(frame, text, (gravity_point[0]+10, gravity_point[1]+10), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 255, 255), 1, 8, 0)
