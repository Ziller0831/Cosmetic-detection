    ...
    while True:
        ...
        for contour in contours:
            ...
            if(vector_a_value < vector_b_value):
                vector = vector_a
                point1 = (minRect[1] + minRect[2])/2
                point2 = (minRect[0] + minRect[3])/2
            ...
            length1 = ((center_point[0]-minRect[0][0])**2+(center_point[1]-minRect[0][1])**2)**0.5
            length2 = ((center_point[0]-minRect[1][0])**2+(center_point[1]-minRect[1][1])**2)**0.5
            # if(center_point):
            #     pass
            
            print(f"a:{length1:.4f}, b:{length2:.4f}, {vector},{theta:.4f}")
            ...
            cv2.circle(frame, point1, 3, (100,100,255), -1)
            cv2.circle(frame, point2, 3, (100,100,255), -1)
