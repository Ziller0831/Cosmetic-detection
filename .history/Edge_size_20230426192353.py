...
if __name__ == '__main__':
    ...
    while len(AreaSizeData) < 100: ## 樣本數
        ret, frame = cap.read()
        if not ret:
    ...
    print(f'AreaContours: Max Min Mean Std/n', areaMaxCont, 'Min:', areaMinCont, "Mean:", areaMeanCont, 'Std:', areaStdCont)
    ...
    # print('LengthContours','Max:', LengthMaxCont, 'Min:', LengthMinCont, "Mean:", LengthMeanCont, 'Std:', LengthStdCont)
