...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            long_GC_theta = long_vect @ GC_vect / (vect_long_val * vect_GC_val)

            if long_GC_theta < 0 and long_GC_theta >= -1:
                pass
            elif long_GC_theta > 0 and long_GC_theta <= 1:
                pass

            try:
                print(f"{math.ceil(long_GC_theta)}, {long_GC_theta:.2f}, {cos},{theta:.2f}, {theta2:.2f}")
