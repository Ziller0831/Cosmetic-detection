...
cv2.createTrackbar('Red', 'Setting', maxVal//2, maxVal, nothing)   # 建立數值設定條
...
while 1:
    ...
    red_val = cv2.getTrackbarPos('Red', 'Setting')

    retval, r = cv2.threshold(RImage, red_val, maxVal, cv2.THRESH_OTSU)
