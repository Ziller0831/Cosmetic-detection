...
while 1:
    ...
    imgBinary =barycenterSearch(imgBinary, contours)
    
    cv2.drawContours(imgBinary, contours, -1, (0,0,255), 2)
    for min_rect in min_rect_array:
        cv2.drawContours(imgBinary, [min_rect], 0, (0, 255, 0), 2)
    cv2.imshow("Result", imgBinary)
