...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            print(f"{gravity_point}, {vector_a},,{vector_b},{vector1},{length1:.4f},{length2:.4f}. {theta:.4f}, {theta1:.4f}")

            vector_aa = gravity_point[0]-point1[0]
            vector_bb = gravity_point
            length1 = ((gravity_point[0]-point1[0])**2+(gravity_point[1]-point1[1])**2)**0.5
