...
Csv_Dir = r"C:\Users\TEST\Desktop\HaoYing0801\Data\Cosmetic_parameter.csv"
TCP_host = "0.0.0.0"
TCP_port = "7000"
...
if __name__ == "__main__":
    ...
    if Mode == 0:  ##! 物件輪廓選擇mode
        ...
        for i in calibration:
            FP.XMLWrite(r"C:\Users\TEST\Desktop\HaoYing0801\Data\Setting.xml", str(i),  [[float(num) for num in row] for row in calibration[str(i)]])
    
    elif Mode == 2: ##! working mode
        TF_para = {"camera_matrix": 0, "rvecs": 0, "tvecs": 0}
        for i in TF_para:
            TF_para[i] = FP.XMLRead(r"C:\Users\TEST\Desktop\HaoYing0801\Data\Setting.xml", str(i))
