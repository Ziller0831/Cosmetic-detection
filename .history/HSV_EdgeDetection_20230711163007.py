    ...
    while True:
        ...
        for contour in contours:
            ...
            if(vector_a_value < vector_b_value):
                vector = vector_a
                point1 = int((minRect[1] + minRect[2])/2)
                point2 = int((minRect[0] + minRect[3])/2
            elif(vector_a_value > vector_b_value):
                vector = vector_b
                point1 = int((minRect[0] + minRect[1])/2
                point2 = int((minRect[2] + minRect[3])/2
            ...
            print(f"a:{point1}, b:{point2}, {vector},{theta:.4f}")
