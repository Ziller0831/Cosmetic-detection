...
if __name__ == '__main__':
    ...
    while True:
        ...
        for contour in contours:
            ...
            # theta = cv2.fastAtan2(int(vector_a[0]), int(vector_a[1]))
            theta = azimuthAngle(point2[0], point2[1],gravity_point[0],gravity_point[1])

            # print(f"{minRect[1]},{minRect[0]},{vector}, {theta:.4f}")

            vector_aa = gravity_point - point2
            ...
            theta1 = azimuthAngle(point2[0], point2[1],gravity_point[0],gravity_point[1])
            
            print(f"{gravity_point}, {point1},{point2},{vector1}, {theta:.4f}, {theta1:.4f}")
            ...
            endPoint1 = [int(center_point[0]+ArrowLength*math.cos(math.radians(theta1))), int(center_point[1]+(-ArrowLength*math.sin(math.radians(theta1))))]
            ...
            # cv2.arrowedLine(frame, center_point, endPoint1, (0,0,255), 2)
