...
class EdgeDetector:
    ...
    def FeaturesCalc(self, frame, contours):
        ...
        resultArray  = []   ##* Output array(catch point[x, y], angle)
        ...
        for contour in contours:
            ...
            if self._modeSW == 2:
                ...
                try:
                    ...
                    resultArray.append([catch_p[0], catch_p[1], round(angle, 4)])
                except:
                    pass
    ...
    def _MinRectCircle(self, contour):
        ...
        return np.int0(rawMinRect[0]), min_rect, round(raw_MinRect[2], 4)
    ...
    def _AngleCalc(self, minRect_P, G2C_vect):
        ...
        longG_C_cos = long_vect @ G2C_vect / (vect_val * vect_GC_val)
