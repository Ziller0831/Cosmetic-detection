...
class EdgeDetector:
    def __init__(self, ModeSW = 2, TF_parm = "", *ProductFeatures):
        _areaAvg       = Product_features[0][0]
        _areaStd       = Product_features[0][1]
        _productColor  = Product_features[0][2]
        self._catchOffset   = Product_features[0][3]
        self._productHeight = Product_features[0][4]
        ...
        if ModeSW == 2: 
            ...
            self._AreaRange = [_area_avg-_area_Std*3, _area_avg+_area_Std*3]
