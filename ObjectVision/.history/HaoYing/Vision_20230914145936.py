...
Camera2Robot_coord = r"C:\Users\TEST\Desktop\HaoYing_Final\ObjectVision\Data\Camera_to_Robot.csv"

class EdgeDetector:
    def __init__(self, ModeSW = 2, objectColor = "", TF_parm = "", *Product_features):
        self.cap = cv2.VideoCapture(1, cv2.CAP_DSHOW)

        # TODO: 改成用產品顏色處理
        if objectColor == '黑長樣品蓋' or Object == '黑長樣品瓶' or Object == '黑色口紅座':
            self.cap.set(cv2.CAP_PROP_BRIGHTNESS, 220) #200
            self.cap.set(cv2.CAP_PROP_CONTRAST, 60) #45
        else:   ##! 黑色背景
